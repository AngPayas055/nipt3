    ...
    <div class="layout-sidebar" [ngClass]="{ active: active }">
      ...
      <div class="layout-menu">
        ...
        <div class="menu-items">
          <a routerLink="/Sales" routerLinkActive="router-link-exact-active"
            >Sales / Marketing</a
          >
          <a routerLink="/yard" routerLinkActive="router-link-exact-active"
            >Yard Management</a
          >
          <a routerLink="/receiving" routerLinkActive="router-link-exact-active"
            >Receving Management</a
          >
          <a routerLink="/storage" routerLinkActive="router-link-exact-active"
            >Storage Management</a
          >
          <a
            routerLink="/dispatching"
            routerLinkActive="router-link-exact-active"
            >Dispatching Management</a
          >
          <div>
            <a tabindex="0" (click)="toggleSubmenu($event, '/administration')"
              >Administration</a
            >
            <div
              [@submenu]="
                isSubmenuActive('/administration') ? 'visible' : 'hidden'
              "
            >
              <ul>
                <li>
...
export class AppMenuComponent {
  ...
  adminSidNavSubItems: any[] = [
    ...
    { name: 'Storages', link: '/application/storages' },
    { name: 'Materials', link: '/application/materials' },
    { name: 'Selections', link: '/application/selections' },
  ];
  ...
  constructor(private el: ElementRef, private router: Router) {
    if (this.user_type == 'Admin') this.sideNavItems = this.adminSidNavItems;
    this.sideNavSubItems = this.adminSidNavSubItems;
  }
